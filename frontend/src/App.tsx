  ...
  return (
    <ThemeProvider>
      <Routes>
        ...
        <Route path="/orders" element={<Navigate to="/orders?status=ASSIGNED,IN_TRANSIT" replace />} />
        <Route path="/orders?status=ASSIGNED,IN_TRANSIT" element={<MainLayout><Orders /></MainLayout>} />
        <Route path="/orders?status=DELIVERED,CANCELLED" element={<MainLayout><Orders /></MainLayout>} />
        <Route path="/orders?status=PENDING" element={<MainLayout><Orders /></MainLayout>} />
